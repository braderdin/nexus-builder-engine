...
export default function DashboardPage() {
  ...
  // Start: Gemini Self-Healing Engine Core States
  ...
  // End: Gemini Self-Healing Engine Core States
  ...
  // Start: Gemini Intelligent Self-Healing Connector Pipeline
  ...
  // End: Gemini Intelligent Self-Healing Connector Pipeline
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-2xl p-5 space-y-4 shadow-xl">
              ...
              {repairedJsonResult && (
                <div className="space-y-2 pt-2 border-t border-slate-800">
                  ...
                  <button
                    onClick={() => setActivePreviewJson(repairedJsonResult)}
