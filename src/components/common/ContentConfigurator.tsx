        ...
        <input
          ...
          onChange={(e) =>
            setActivePreviewJson((prev) => ({
              ...prev,
              heroSection: { ...(prev.heroSection || {}), headline: e.target.value },
            }))
          }
      ...
      <div className="space-y-3">
        ...
        <textarea
          ...
          onChange={(e) =>
            setActivePreviewJson((prev) => ({
              ...prev,
              heroSection: { ...(prev.heroSection || {}), subheadline: e.target.value },
            }))
          }
      ...
      <div className="space-y-3">
        ...
        <input
          ...
          onChange={(e) =>
            setActivePreviewJson((prev) => ({
              ...prev,
              whatsappFormSection: { ...(prev.whatsappFormSection || {}), targetNumber: e.target.value },
            }))
          }
      ...
      <div className="space-y-3">
        ...
        <input
          ...
          onChange={(e) =>
            setActivePreviewJson((prev) => ({
              ...prev,
              whatsappFormSection: { ...(prev.whatsappFormSection || {}), buttonText: e.target.value },
            }))
          }
